...
# exportar_resumen_contenedores(fecha_inicio = "2025-07-01", fecha_fin = "2026-07-22", Solo_activos = TRUE, Oficina = "IM")
#
# Caso 2: Obtener el total de contenedores (activos e inactivos) de toda la base (Oficina = "Total")
# exportar_resumen_contenedores(fecha_inicio = "2025-07-01", fecha_fin = "2026-07-22", Solo_activos = TRUE, Oficina = "Total")
#
