...
d <- readRDS("informes/Condicion_peorescasos/datos_informe_html.rds")

tpl <- readLines("informes/Condicion_peorescasos/informe_template.html", warn = FALSE)
...
out_path <- "informes/Condicion_peorescasos/informe_peores_condicion_MunicipioB.html"
