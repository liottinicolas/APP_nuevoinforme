...
# # 2. Guardar los 4 archivos .rds (Sobrescribir los anteriores)
# # Ajustá los nombres de los objetos (el primer parámetro) según los tengas en R
# saveRDS(df_informe_solo_im, file.path(data_dir, "informediarionuevo_total_soloim_criterioadrian.rds"))
# saveRDS(df_viajes_solo_im,  file.path(data_dir, "total_viajesporcamionsoloim_criterioadrian.rds"))
# saveRDS(df_informe_total,   file.path(data_dir, "informediarionuevo_total_imyfideicomiso_criterioadrian.rds"))
# saveRDS(df_viajes_total,    file.path(data_dir, "total_viajesporcamionIM_fid_criterioadrian.rds"))
