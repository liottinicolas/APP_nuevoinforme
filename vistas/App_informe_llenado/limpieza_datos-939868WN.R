...
# Al escribir los pines, añade 'versioned = FALSE' en cada uno
board %>% pin_write(GID_activos, "GID_activos", type = "rds", versioned = FALSE)
board %>% pin_write(GID_inactivos, "GID_inactivos", type = "rds", versioned = FALSE)
board %>% pin_write(historico_llenado_web, "historico_llenado_web", type = "rds", versioned = FALSE)
